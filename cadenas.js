class Cadenas {
   vocalesConsonantes() {
      ...
      let frase2 = frase.toLowerCase(); // Elimina espacios y convierte a minusculas
   ...
   palabrasFrase() {
      ...
      // .replace(/  +/g, " ") sirve para eliminar espacios de mas
      // .split(" ") sirve para convertir la frase en un arreglo
   ...
   fraseInvertida() {
      ...
      // i = 2 - 1    2 >= 0  i--
      // salida = "al" + frase[1] = "alo"

      // i = 1 - 1    1 >= 0  i--
      // salida = "alo" + frase[0] = "aloh"
   ...
   buscarSubcadena() {
      ...
      // Sirve para buscar la posicion de una subcadena en una frase
   ...
   insertarSubcadena() {
      ...
      // slice sirve para cortar una cadena
